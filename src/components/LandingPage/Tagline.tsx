...
export const Tagline: React.FC = () => {
  return (
    ...
    >
      <p className="font-roboto-condensed-extralight font-extralight text-[18px] text-[rgba(251,251,251,1)] max-sm:text-[14px] max-[375px]:text-[12px] border-popover-foreground">
